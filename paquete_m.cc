...
unsigned int Paquete::getSecuencia() const
{
    return this->secuencia;
}

void Paquete::setSecuencia(unsigned int secuencia)
{
    this->secuencia = secuencia;
}

short Paquete::getAck() const
{
    return this->ack;
}

void Paquete::setAck(short ack)
{
    this->ack = ack;
}

::omnetpp::simtime_t Paquete::getTimestamp() const
{
    return this->timestamp;
}

void Paquete::setTimestamp(::omnetpp::simtime_t timestamp)
{
    this->timestamp = timestamp;
}

::omnetpp::simtime_t Paquete::getTxFinish() const
{
    return this->txFinish;
}

void Paquete::setTxFinish(::omnetpp::simtime_t txFinish)
{
