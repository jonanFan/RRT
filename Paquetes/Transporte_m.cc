...
Transporte& Transporte::operator=(const Transporte& other)
{
...
void Transporte::setSecuencia(unsigned int secuencia)
{
    this->secuencia = secuencia;
}

short Transporte::getAck() const
{
    return this->ack;
}

void Transporte::setAck(short ack)
{
    this->ack = ack;
}

::omnetpp::simtime_t Transporte::getTimestamp() const
{
    return this->timestamp;
}

void Transporte::setTimestamp(::omnetpp::simtime_t timestamp)
{
    this->timestamp = timestamp;
}

::omnetpp::simtime_t Transporte::getTxFinish() const
{
...
class TransporteDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    TransporteDescriptor();
    virtual ~TransporteDescriptor();
...
Register_ClassDescriptor(TransporteDescriptor)

TransporteDescriptor::TransporteDescriptor() : omnetpp::cClassDescriptor("Transporte", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

TransporteDescriptor::~TransporteDescriptor()
{
    delete[] propertynames;
}

bool TransporteDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Transporte *>(obj)!=nullptr;
}

const char **TransporteDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *TransporteDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *TransporteDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *TransporteDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int TransporteDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *TransporteDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string TransporteDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool TransporteDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *TransporteDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *TransporteDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
