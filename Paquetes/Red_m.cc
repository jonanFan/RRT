...
unsigned short Red::getSrcAddr() const
{
    return this->srcAddr;
}

void Red::setSrcAddr(unsigned short srcAddr)
{
    this->srcAddr = srcAddr;
}

unsigned short Red::getDstAddr() const
{
    return this->dstAddr;
}

void Red::setDstAddr(unsigned short dstAddr)
{
